...
public class SecurityConfig {
    ...
    private final PasswordEncoder passwordEncoder;
     public SecurityConfig(@Lazy UserDetailsServiceImp userDetailsServiceImp, @Lazy PasswordEncoder passwordEncoder,
            CustomLogoutHandler logoutHandler, @Lazy JwtAuthenticationFilter jwtAuthenticationFilter) {
